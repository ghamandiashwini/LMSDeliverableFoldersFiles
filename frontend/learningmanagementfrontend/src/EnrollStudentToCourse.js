...
function EnrollStudentToCourse() {
  ...
  const handleEnrollStudenttoCourse = async () => {
    try {
      ...
      const response = await axios.post('http://localhost:5000/api/studentcourse/enrollstudenttocourse', { rollno, courseno});
       ...
       <div className="col-md-6">
                    <div className="card">
                        <div className="card-header">
                            <b>Enroll student into Course</b>
                        </div>
                        <div className="card-body">
                            <div className="row">
                               <div className="col-md-4">
                                ...
                                <div className="col-md-4">
                                <label htmlFor="course-dropdown">Select a Student: </label>
                                    <select
                                        id="course-dropdown"
                                        value={rollno}
                                ...
                                <div className="col-md-4">
                                  <button onClick={handleEnrollStudenttoCourse}>Enroll Student</button>    
                                 </div>
                            </div>
